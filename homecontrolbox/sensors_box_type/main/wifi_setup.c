...
void little_blink_led(void) {
    ESP_ERROR_CHECK(ledc_set_duty(LEDC_MODE, LEDC_OUTPUT_G_CHANNEL, SHORT_BLINK_DUTY));
    ESP_ERROR_CHECK(ledc_update_duty(LEDC_MODE, LEDC_OUTPUT_G_CHANNEL));
    vTaskDelay(SHORT_BLINK_TIME);

    ESP_ERROR_CHECK(ledc_set_duty(LEDC_MODE, LEDC_OUTPUT_G_CHANNEL, LITTLE_BLINK_DUTY));
    ESP_ERROR_CHECK(ledc_update_duty(LEDC_MODE, LEDC_OUTPUT_G_CHANNEL));
